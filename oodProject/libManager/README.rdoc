...
*6. View Entire checkout history for users*
...
----------------------
    ...
    1. As a user, go to any checked-out book and check the details of the book. Click on the norify button to get an     email when the book is returned and available.
